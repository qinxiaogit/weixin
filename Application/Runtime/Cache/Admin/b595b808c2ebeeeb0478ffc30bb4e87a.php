...
<head>
	...
	<script src="/weixin/Public/javascripts/admin/bootstrap.min.js"></script>
    ...
    <div class="my-bg">
      <div class="container container-fluid">
       <form class="form-signin"  method="post" action="<?php echo U('/Index/CheckLoginfo');?>">
        ...
        <input type="password" name="login_passwd" id="inputPassword" class="form-control" placeholder="Password" required>
        <input type="text" name="code" id="inputcode" class="form-control" placeholder="验证码" required/>
        <img width="48%" id="yzm" class="left15" height="50" alt="验证码" src="<?php echo U('/Index/Verify',array());?>" title="点击刷新">
